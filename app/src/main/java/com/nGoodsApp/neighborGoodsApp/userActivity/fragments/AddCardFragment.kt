...
class AddCardFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.addCardProceed.setOnClickListener {
            ...
            if (binding.cardNumberInput.text.isInValidOtpDigit() || binding.cardNumberInput.text!!.length!=12) {
                ...
                viewModel.addCard(binding.cardNumberInput.text.toString(), binding.cardExpiryInput.text.toString().substring(0,2), binding.cardExpiryInput.text.toString().substring(2,4).toInt())
            }
        }
